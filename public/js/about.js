 ...
 */
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery"), require("popper.html")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], e) : e(t.bootstrap = {}, t.jQuery, t.Popper) }(this, function(t, e, h) {
    "use strict";
...
$(document).ready(function() {
    $('.year-slider').slick({ slidesToShow: 4, slidesToScroll: 1, arrows: true, dots: false, focusOnSelect: true, autoplay: false, asNavFor: '.year-details-slider', responsive: [{ breakpoint: 1024, settings: { slidesToShow: 3, slidesToScroll: 3, infinite: true, dots: true } }, { breakpoint: 600, settings: { slidesToShow: 2, slidesToScroll: 2 } }, { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1 } }] });
    $('.year-details-slider').slick({ slidesToShow: 4, slidesToScroll: 1, asNavFor: '.year-slider', dots: false, arrows: true, autoplay: false, focusOnSelect: true, responsive: [{ breakpoint: 1024, settings: { slidesToShow: 3, slidesToScroll: 3, infinite: true, dots: true } }, { breakpoint: 600, settings: { slidesToShow: 2, slidesToScroll: 2 } }, { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1 } }] });
});;
$('.ubermenu-responsive-toggle').on('mousedown touchstart', function() { $('body').toggleClass('mobile-submenu-fixed'); });
...
new WOW().init();
/* $(document).ready(function() { $('.c-header_nav_burger').click(function() { $('.nav-main').toggleClass('block'); }); }); */
$(document).ready(function() {
    $('.quick').click(function() { $('.form-popup').addClass('formopen') });
    $('.cancel').click(function() { $('.form-popup').removeClass('formopen') });
});